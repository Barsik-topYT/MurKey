"""MurKey 2.2 — активация Windows 10/11 (GUI и CLI). by BarsikYT"""
import sys
import os
import time
import ctypes
...
def launch_cli():
    ...
    {Fore.YELLOW}{Style.BRIGHT}{'M U R K E Y  2.2'.center(60)}{Style.RESET_ALL}
...
def launch_gui():
    ...
    class WinActivatorApp(ctk.CTk):
        ...
        def _build_sidebar(self):
            ...
            ctk.CTkLabel(
                inner, text="MurKey", font=ctk.CTkFont(size=20, weight="bold"), text_color=ACCENT,
